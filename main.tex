...
%\inputminted[colback=gray!40!black, colframe=blue, linenos, frame=single, fontsize=\footnotesize]{python}{test.py}
%\inputminted[bgcolor=gray!40!black, linenos, frame=single, fontsize=\footnotesize]{python}{test.py}
%\inputminted[bgcolor=gray!40!black, linenos]{python}{test.py}
\inputminted{python}{test.py}
%\inputminted{pythoncode3}{test.py}

%\pythoninc{How to calculate a factorial}{test.py}

%\pythoninc{title}{test.py}
%\pythoninc{test.py}
%\begin{python}
%\inputpythonfile{test.py}
%\end{python}

\begin{python}[Test Title](style=one-dark){colback=gray!40!black,colframe=blue}
def factorial(n):
...
%\input{|python include.py test test.py}

%\input{|python -c "print('hei')"}

%\lstinputlisting[language=python]{test.py}
%\begin{python}[How to calculate a factorial](style=one-dark){colback=gray!40!black,colframe=blue}[test.py]
%\inputminted{python}{test.py}
%hello
%\end{python}

%\inputminted{python3}{test.py}

%\pythoncode4{test.py}

%\begin{pythoncodeA}{How to calculate a factorial}
%\inputminted{python}{test.py}
%\end{pythoncodeA}
